...
public class CaptchaUtil {
     ...
     * @return
     */
    public static String generateCaptchaCode(int captchaSize){
        return generateCaptchaCode(captchaSize, CAPTCHA_CODES);
    }
     ...
     * @return
     */
    public static String generateCaptchaCode(int captchaSize, String sources){
     ...
     * @throws IOException
     */
    public static String outputCaptchaImage(int w, int h, File outputFile, int captchaSize) throws IOException{
        String captchaCode = generateCaptchaCode(captchaSize);
    ...
    public static void main(String[] args) throws IOException{
        ...
        for(int i = 0; i < 50; i++){
            ...
            File file = new File(dir, captchaCode + ".jpg");
            outputImage(w, h, file, captchaCode);
        }
    }
