...
<body class="zhi ">
    ...
    <div class="zg-wrap zu-main clearfix " role="main">
        ...
        <div class="zu-main-content-inner">
            <ul class="tab-navs">
                <li class="tab-nav ">
                    <a href="${ctx}/collections">我关注的收藏夹</a>
                </li>
            ...
            <div id="zh-favlists-wrap">

                <div class="zm-item" id="mi-1485054164">
                    <h2 class="zm-item-title">

                        <a href="${ctx}/collection/60760155">标题</a>

                    </h2>
                    <div class="zm-item-meta">
                        <div class="zm-item-meta-actions">

                            <span href="javavscript:;">120 条内容</span>

                            <span class="zg-bull">•</span>
                            <a class="zg-unfollow" href="${ctx}/collection/60760155/followers">0 人关注</a>
            ...
            <a href="javascript:;" id="zh-load-more" class="zg-btn-white zg-r3px zu-button-more" style="">更多</a>
                ...
                <div class="zm-side-nav-group">
                    <ul class="zm-side-nav" id="zg-sidebar-nav">
                        ...
                        <li class="zm-side-nav-li">
                            <a class="zm-side-nav-link active" href="${ctx}/collections"
        ...
        <div class="zm-side-section">
            <div class="zm-side-section-inner">
                <a href="${ctx}/collections/mine#" id="zh-list-create-new-list">+ 创建收藏夹</a>
            </div>
        </div>
    </div>
    </div>
